 ...
 */
    ...
    if (options) {
      ...
      if ('itemsAlwaysDraggable' in options) {
        if (typeof options.itemsAlwaysDraggable === 'boolean') {
          ...
          this.options.itemsAlwaysDraggable = { ...this.options.itemsAlwaysDraggable, ...options.itemsAlwaysDraggable }
      ...
      if ('margin' in options) {
        if (typeof options.margin === 'number') {
          ...
          this.options.margin = { ...this.options.margin, ...options.margin }
      ...
      if ('editable' in options) {
        if (typeof options.editable === 'boolean') {
          ...
          this.options.editable = { ...this.options.editable, ...options.editable }
        }
      }
      ...
      if ('groupEditable' in options) {
        if (typeof options.groupEditable === 'boolean') {
          ...
          this.options.groupEditable = { ...this.options.groupEditable, ...options.groupEditable }
  ...
  _onAddGroups(ids) {
    ...
    ids.forEach(id => {
      ...
      if (!group) {
        ...
        const groupOptions = { ...me.options, height: null };
  ...
  _onGroupDragEnd(event) {
    ...
    if (this.options.groupEditable.order && this.groupTouchParams.group) {
      ...
      const groupData = { ...dataset.get(id) }; // clone the data
